...
5. The Windows-dedicated path validation had a WSL gap: real `C:\Users\<user>\AppData\Local\ServiceNowAutomation\...` paths were not accepted unless `%LOCALAPPDATA%` existed in the Node process.
...
6. Stop before Save/Submit/Update/Close
...
- no Save/Submit/Update/Close automation
