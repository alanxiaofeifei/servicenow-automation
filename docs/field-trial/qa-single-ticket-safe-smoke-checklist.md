...
It does not authorize a ServiceNow login, page inspection, Save, Submit, Update, Close, browser DOM autofill, ServiceNow API call, Graph/Excel write, attachment upload, or bulk creation.
