...
"This is a fake/sanitized QA rehearsal. The app prepares drafts and evidence; it does not write to ServiceNow, does not call ServiceNow APIs, does not autofill a browser, and does not use real customer data. Any real QA Save, Submit, Update, Resolve, or Close would require a separate exact approval phrase."
