# Phase BF6 — Windows Local Package Refresh

**Date:** 2026-06-07
**Build profile:** `sna-windows-runtime`
**Task:** `t_5f4205b5`
**Parent tasks:** `t_4ef7e792` (BF5 privacy/security APPROVE), `t_a0b67ad1` (BF4 QA PASS)
**Child task:** `t_671764f0`
...
Fresh BF6 Windows local package built from HEAD (`019c502 AG1-DelC`). All 4 required gates pass. Artifacts published to `dist/release/` with ZIP, SHA256 sidecar, and START-HERE-WINDOWS.txt.
...
```bash
SDA_RELEASE_VERSION=v0.1.0-rc.1-bf6-20260607-local \
...
| Artifact | Size |
|----------|------|
| `servicenow-automation-windows-v0.1.0-rc.1-bf6-20260607-local.zip` | 114 MB |
| `servicenow-automation-windows-v0.1.0-rc.1-bf6-20260607-local.zip.sha256` | 131 B |
| `servicenow-automation-windows-v0.1.0-rc.1-bf6-20260607-local-START-HERE-WINDOWS.txt` | 955 B |

**SHA256 checksum:**
```
3e12d093e46686d2f0c20bf5efb34beaf1f7372bbcf94b63338d235b5c4c2a33  servicenow-automation-windows-v0.1.0-rc.1-bf6-20260607-local.zip
```
...
1. Copy `dist/release/servicenow-automation-windows-v0.1.0-rc.1-bf6-20260607-local.zip` to a Windows machine
